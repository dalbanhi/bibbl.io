const ShelfLinks = (props) => {
    ...
    return (
        <div className="m-2"> 
            ...
            <ReactBootstrap.DropdownButton as = {ReactBootstrap.ButtonGroup} size="sm" id="dropdown-button-drop-up" drop="down" variant="info" title={state.title}>
                {
